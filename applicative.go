...
func (o ApplicativeLaws) Identity(run Morphism) (func(v int) Any, func(v int) Any) {
	f := func(v int) Any {
...
func (o ApplicativeLaws) Composition(run Morphism) (func(v int) Any, func(v int) Any) {
	f := func(v int) Any {
...
func (o ApplicativeLaws) Homomorphism(run Morphism) (func(v int) Any, func(v int) Any) {
	f := func(v int) Any {
		a := o.x.Of(Identity).(Applicative)
		b := o.x.Of(v).(Applicative)
...
func (o ApplicativeLaws) Interchange(run Morphism) (func(v int) Any, func(v int) Any) {
	f := func(v int) Any {
		a := o.x.Of(Identity).(Applicative)
		b := o.x.Of(v).(Applicative)
		return run(a.Ap(b).(Applicative))
